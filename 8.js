...
const shape1 = new Cuboid(2,5,10);
 document.write("Cuboid volume "+shape1.Volume + " ");
 document.write("Cuboid surface area "+shape1.surface + " ");
 ...
 document.write("Cube volume "+shape2.Volume2 + " ");
 document.write("Cube surface area "+shape2.surface2 + " ");
